...
func GetBQPrimeUrl() string {
	...
	baseString_2025 := `https://www.ndtvprofit.com/markets/stock-market-today-all-you-need-to-know-going-into-trade-on`
	...
	fullString2025 := baseString_2025 + "-" + monthShortner + "-" + strconv.Itoa(date)

	//creating url
	fullStringUrl2025 := fullString2025 + "-" + strconv.Itoa(yr) //example: https://www.ndtvprofit.com/markets/stock-market-today-all-you-need-to-know-going-into-trade-on-july-23-2
	oneDecrementUrl2025 := fullString2025 + "-" + strconv.Itoa(yr-1)
	...
	fmt.Println("Utils:GetBQPrime:fullstringUrl2025: ", fullStringUrl2025)
	fmt.Println("Utils:GetBQPrime:oneDecrementUrl2025: ", oneDecrementUrl2025)
	...
	if req.StatusCode == 200 {
		fmt.Printf("in full string url", req.StatusCode)
		return fullStringUrl
	}

	req2024, _ := http.Get(fullStringUrl2025)

	if req2024.StatusCode == 200 {
		fmt.Printf("in 2024 full string url")
		return fullStringUrl2025
	}

	req2024Decr, _ := http.Get(oneDecrementUrl2025)

	if req2024Decr.StatusCode == 200 {
		fmt.Println("in 2025 one string decreament ")
		return oneDecrementUrl2025
	}
